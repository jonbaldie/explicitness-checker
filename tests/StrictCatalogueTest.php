...
class StrictCatalogueTest extends TestCase
{
    ...
    public function testReportsRuntimeConfiguration(): void
    {
        $this->assertFindings([
            ...
            'ini_alter($a, $b)' => [[], [['writes runtime configuration (ini_alter)', Category::RUNTIME_CONFIG]]],
            'restore_error_handler()' => [[], [['writes runtime configuration (restore_error_handler)', Category::RUNTIME_CONFIG]]],
            'restore_exception_handler()' => [[], [['writes runtime configuration (restore_exception_handler)', Category::RUNTIME_CONFIG]]],
